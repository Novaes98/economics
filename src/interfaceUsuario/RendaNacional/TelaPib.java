...
public class TelaPib extends FrameSecundario {
	...
	public TelaPib() {
		inserirImagem("PIB.jpg", width / 8 + 68 , height / 3 - 23);
		initComponents();
...
private void inicializaExtras() {
		...
		JScrollPane panelQtdProdutoA = caixaDeTexto(qtdProdutoA, width / 8, height / 3 + 100,
		...
		JScrollPane panelQtdProdutoB = caixaDeTexto(qtdProdutoB, width / 8 + 300, height / 3 + 100,
				dQtdProdutoA.width + 10, dQtdProdutoA.height + 5);
		...
		JScrollPane panelPrecoA = caixaDeTexto(precoA, width / 8, height / 3 + 200,
				dQtdProdutoA.width + 10, dQtdProdutoA.height + 5);
		...
		JScrollPane panelPrecoB = caixaDeTexto(precoB, width / 8 + 300, height / 3 + 200,
				dQtdProdutoA.width + 10, dQtdProdutoA.height + 5);
		...
		tfQtdProdutoA.setBounds(width / 8, height / 3 + 125, dQtdProdutoA.width + 10, dQtdProdutoA.height + 5);
		tfQtdProdutoA.setText("Digite um numero inteiro positivo");
		getContentPane().add(tfQtdProdutoA);

		tfQtdProdutoB = new JTextField();
		tfQtdProdutoB.setBounds(width / 8 + 300, height / 3 + 125, dQtdProdutoA.width + 10,
		...
		tfPrecoA.setBounds(width / 8, height / 3 + 225, dQtdProdutoA.width + 10, dQtdProdutoA.height + 5);
		tfPrecoA.setText("Formato ##.## ou um inteiro positivo");
		getContentPane().add(tfPrecoA);

		tfPrecoB = new JTextField();
		tfPrecoB.setBounds(width / 8 + 300, height / 3 + 225, dQtdProdutoA.width + 10,
				dQtdProdutoA.height + 5);
